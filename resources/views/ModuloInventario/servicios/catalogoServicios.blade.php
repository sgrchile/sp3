        ...
        <div class="porlets-content">
          ...
          <table class=" table-condensed table-bordered ">
            ...
            <tr>
              ...
              <td><a href="{{route('modificarServicio')}}"><button type="button" class="btn btn-primary btn-xs">MODIFICAR</button></a></td>
              <td><a href="{{route('fichaDeServicio')}}"><button type="button" class="btn btn-primary btn-xs">VER</button></a></td>
            </td>
          </tr>
