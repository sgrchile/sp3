...
<h1 class=" text-center text-uppercase" >ACTUALIZACION DE OFERTA</h1>

<h3 class=" text-center text-uppercase" >OFERTA DE ARTICULOS</h3>
...
@foreach($articulos as $articulo)
  <tr>
    ...
    <td><a href={{route('modificarArticulo', $articulo->OFAR_ID)}}><button class="btn btn-primary btn-sm">ACTUALIZAR</button></a></td>
  </tr>
@endforeach
</table>
...
@foreach($arriendos as $arriendo)
  <tr>
    ...
    <td><a href={{route('modificarArriendo', $arriendo->ARM_ID)}}><button class="btn btn-primary btn-sm">ACTUALIZAR</button></a></td>
  </tr>
@endforeach
</table>
...
@foreach($profesionales as $profesional)
  <tr>
    ...
    <td><a href={{route('modificarProfesional', $profesional->STP_COD)}}><button class="btn btn-primary btn-sm">ACTUALIZAR</button></a></td>
  </tr>
@endforeach
...
<tr>
  ...
  @foreach($servicios as $servicio)
    <tr>
      ...
      <td><a href={{route('modificarServicio', $servicio->OFSER_COD)}}><button class="btn btn-primary btn-sm">ACTUALIZAR</button></a></td>
    </tr>
  @endforeach
</table>
