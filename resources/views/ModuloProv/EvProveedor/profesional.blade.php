...
<h1 class=" text-center text-uppercase" >EVALUAR OFERTA TÉCNICO PROFESIONAL</h1>
<form action="{{route('patch.evaluar.profesional', $profesionales->STP_COD)}} " method="post">
{{ csrf_field() }}
{{ method_field('PATCH') }}
