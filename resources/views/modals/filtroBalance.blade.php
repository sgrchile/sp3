...
<div class="modal fade" id="filtroBalance" role="dialog" >
    <div class="modal-dialog modal-lg" align="center">
        ...
        <div class="modal-content" >
            ...
            <div class="modal-body">
                <form id="form1" name="form1" method="post" action="{{ route('post.balance') }}">
                {{ csrf_field() }}
                ...
                <tr>
                    <td>{!! Form::date('desde',null,['class'=>'form-control','style'=>'width:175px',]) !!}</td>
                </tr>
                ...
                <tr>
                    <td>{!! Form::date('hasta',null,['class'=>'form-control','style'=>'width:175px',]) !!}</td>
                </tr>
